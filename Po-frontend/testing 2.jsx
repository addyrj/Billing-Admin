...
const handleProductChange = (index, e) => {
  ...
  if (updatedProducts[index].gstIncluded) {
    // If GST is included, calculate total with GST (18%)
    updatedProducts[index].totalPrice = (basePrice * 1.18).toFixed(2);
  } else {
    // If GST is not included, use base price
...
// Calculate grand total
 ...
 <div className="sales-container3">
  ...
  {errorFields.products && (
    ...
    <div className="sales-grand-total-mobile">
      Grand Total: ₹{calculateGrandTotal().toFixed(2)}
    </div>
  </div>
</div>
            ...
            <div className="sales-payment-section">
              ...
              <div className="sales-form-group">
                <label>Payment Reference/Remarks</label>
                <input
                  type="text"
