...
const EditGrn = () => {
        ...
        if (result.success && result.data) {
          ...
          setFormData({
            ...
            items: grnData.items.map((item, index) => ({
              ...
              damageAmount: (item.damage_quantity * item.per_unit_cost).toFixed(2),
            })),
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_API_BASE_URL}/grn/${id}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 bg-white">
      <div className="flex flex-col items-center mb-4">
        ...
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-bold text-black">EDIT GOODS RECEIPT NOTE</h2>
