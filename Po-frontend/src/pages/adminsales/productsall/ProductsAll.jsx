...
const ProductsAll = () => {
  ...
  if (error) return (
    <div className="products-error-container">
      ...
      <button className="products-retry-button" onClick={() => window.location.reload()}>
        Retry
      </button>
    </div>
  );
  ...
  return (
    <div className="products-container">
      <div className="products-header">
        <h1 className="products-title">List of Created All Orders by all partners</h1>
        <div className="products-search-container">
          ...
          <input
            ...
            className="products-search-input_23"
          />
        </div>
      </div>
            ...
            {currentItems.map((company) => (
              <tr key={company.id}>
                ...
                <td data-label="Action">
                  ...
                  >
                    <DeleteIcon className="products-action-icon" />
                  </button>
                </td>
                ...
                <td data-label="Contact No">
                  {company.contactNumbers?.length > 0 ? (
                    <ul className="products-contact-list">
                  ...
                  {company.products?.length > 0 ? (
                    <ul className="products-list">
                      {company.products.map((product, index) => (
                        <li key={index}>
                          <div className="products-item-header" onClick={() => toggleDropdown(`${company.id}-${index}`)}>
                ...
                <td data-label="Address">
                  <div className="products-address-container">
      ...
      {filteredData.length === 0 && searchTerm && (
        <div className="products-no-results">No companies found matching your search.</div>
      )}
