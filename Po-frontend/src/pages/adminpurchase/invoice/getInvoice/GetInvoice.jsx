...
const POList = () => {
  ...
  const handleView = (id) => {
    navigate(`/adminpurchase/view-invoice/${id}`);
  };

  const handleEdit = (id) => {
    navigate(`/adminpurchase/edit-invoice/${id}`);
  };
                  ...
                  <td>
                    <div className="approval-wrapper">
                      <button
                        ...
                        disabled={userRole !== "adminpurchase" || po.approved}
                      >
                        {po.approved ? "Approved" : "Pending"}
                      </button>
                      {po.approved ? (
  ...
  className={`send-button ${
    po.sent ? "sent" : po.approved ? "pending" : "disabled"
  }`}
