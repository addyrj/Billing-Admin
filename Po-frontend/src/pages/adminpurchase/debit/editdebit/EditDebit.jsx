  ...
  useEffect(() => {
    const fetchDebitNoteData = async () => {
      try {
        ...
        const response = await fetch(`http://localhost:4000/api/debit/${id}`, {
          method: "GET",
          headers: {
        ...
        if (!response.ok) throw new Error("Failed to fetch debit note data");

        const data = await response.json();
        const debitNote = data.data;
        ...
        setFormData({
          debitNoteDate: formatDateForInput(debitNote.debit_note_date),
           debitNoteNumber: debitNote.debit_note_number,
          paymentMode: debitNote.payment_mode,
          buyerPoNo: debitNote.buyer_po_no,
          buyergrnNO: debitNote.grn_no,
          dispatchThrough: debitNote.dispatch_through,
          originalInvoiceNo: debitNote.original_invoice_no,
          originalInvoiceDate: formatDateForInput(
            debitNote.original_invoice_date
          ),
          freight: debitNote.freight.toString(),
          consignee: {
            name: debitNote.consignee.name,
            address: debitNote.consignee.address,
            gstin: debitNote.consignee.gstin,
            state: debitNote.consignee.state,
            code: debitNote.consignee.code,
          },
          buyer: {
            address: debitNote.buyer.address,
          },
        ...
        setFreight(debitNote.freight.toString());
        
    setDebitNoteNumber(debitNote.debit_note_number);
    setGrnNumber(debitNote.grn_no); 
      } catch (error) {
        console.error("Error fetching debit note data:", error);
        alert("Failed to load debit note data: " + error.message);
        navigate("/adminpurchase/all-debit");
      } finally {
        setIsLoading(false);
      }
    };
  ...
  const validateForm = () => {
    ...
    if (!formData.consignee.gstin) {
      ...
      errors.consigneeGstin =
        "Invalid GSTIN format (15 alphanumeric characters)";
    }
    ...
    try {
     ...
     `${import.meta.env.VITE_API_BASE_URL}/debit/${id}`,
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.message || "Failed to update debit note");
      }
      ...
      setTimeout(() => navigate("/adminpurchase/all-debit"), 3000);
    } catch (error) {
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 bg-white">
      <div className="flex flex-col items-center mb-4">
        ...
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-bold text-black">EDIT DEBIT NOTE</h2>
    <p className="text-md text-blue-600">DEBIT NOTE:-  {formData.debitNoteNumber}</p>
              ...
              <div className="grid grid-cols-5 gap-2 items-center">
                ...
                <div className="col-span-3">
                  <input
                    ...
                    onChange={(e) =>
                      handleConsigneeChange("name", e.target.value)
                    }
              ...
              <div className="grid grid-cols-5 gap-2 items-center">
                ...
                <div className="col-span-3">
                  <textarea
                    ...
                    onChange={(e) =>
                      handleConsigneeChange("address", e.target.value)
                    }
                    rows="2"
                    className={`w-full p-2 border ${
              ...
              <div className="grid grid-cols-5 gap-2 items-center">
                ...
                <div className="col-span-3">
                  <input
                    ...
                    onChange={(e) =>
                      handleConsigneeChange("gstin", e.target.value)
                    }
                    className={`w-full p-2 border ${
              ...
              <div className="grid grid-cols-5 gap-2 items-center">
                ...
                <div className="col-span-3">
                  <input
                    ...
                    onChange={(e) =>
                      handleConsigneeChange("state", e.target.value)
                    }
                    className={`w-full p-2 border ${
              ...
              <div className="grid grid-cols-5 gap-2 items-center">
                ...
                <div className="col-span-3">
                  <input
                    ...
                    onChange={(e) =>
                      handleConsigneeChange("code", e.target.value)
                    }
                    className={`w-full p-2 border ${
